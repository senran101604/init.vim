...
execute "source " . base_path . "modules/indentline.vim"
execute "source " . base_path . "modules/goyo.vim"
execute "source " . base_path . "themes/gruvbox.vim"
...
execute "source " . base_path . "modules/airline.vim"
...
execute "source " . base_path . "modules/ultisnips.vim"
...
execute "source " . base_path . "modules/ale.vim"
